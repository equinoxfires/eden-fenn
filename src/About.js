...
function About(props) {
  return <div id="About" className="layout">
    ...
    <div class="about-content">
      ...
      <p>Eden's <Link to="/stories" className="about-link" onClick={() => { props.setRoute('stories') }}>short stories</Link> have appeared in <em>Nature Futures</em>, <em>Daily Science Fiction</em>, and <em>Asimov's Science Fiction Magazine</em>.</p>
