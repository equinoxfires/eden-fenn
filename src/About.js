...
function About(props) {
  return <div id="About" className="layout">
    ...
    <div class="about-content">
      <p><strong>Eden Fenn</strong> (she/they) is a science fiction writer and software developer. She lives in Baltimore with her wife and a very bad dog. Eden was born in Danvers, MA, a mile from Rebecca Nurse's house. Rebecca was hanged in the Salem Witch Trials; Eden has not yet been caught.</p>
